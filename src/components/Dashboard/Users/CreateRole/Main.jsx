...
export default function Main() {
  ...
  const handleCheckboxChange = (categoryIndex, permissionType) => {
    ...
    newCheckedItems[categoryIndex][permissionType] = !newCheckedItems[categoryIndex][permissionType];

    // Set the clickedItemText based on the permission type
  ...
  return (
    ...
    <div className='flex w-full p-4 gap-4'>
      <Permissions categories={categories} checkedItems={checkedItems} handleCheckboxChange={handleCheckboxChange} />
      <Allowed categories={categories} checkedItems={checkedItems} clickedItemText={clickedItemText} />
    </div>
  </div>
  );
}