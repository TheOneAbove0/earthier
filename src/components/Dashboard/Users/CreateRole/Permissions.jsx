...
export default function Permissions({ handleCheckboxChange, checkedItems, clickedItemText, categories }) {
  return (
    <div className='flex w-full flex-col gap-4'>
      ...
      <div className='rounded-2xl w-full p-4 flex flex-col gap-2 bg-LightGrey'>
        ...
        {/* Display the text of the clicked item when a checkbox is clicked */}
        {clickedItemText && <p>Clicked item: {clickedItemText}</p>}
              ...
              <div className='flex'>
                <div className='flex items-center w-full px-2 gap-2'>
                  <input
                    ...
                    onChange={() => handleCheckboxChange(categoryIndex, 'actions')}
                  />
                ...
                <div className='flex items-center w-full px-2 gap-2'>
                  <input
                    ...
                    onChange={() => handleCheckboxChange(categoryIndex, 'create')}
                  />
                  <span className='text-[13px] leading-[18px] tracking-[-0.08px] py-1'>
                    {category.create}
                  </span>
              ...
              <div className='flex'>
                <div className='flex items-center w-full px-2 gap-2'>
                  <input
                    ...
                    onChange={() => handleCheckboxChange(categoryIndex, 'permission')}
                  />
                  <span className='text-[13px] leading-[18px] tracking-[-0.08px] py-1'>
                    {category.permission}
                  </span>
                ...
                <div className='flex items-center w-full px-2 gap-2'>
                  <input
                    ...
                    onChange={() => handleCheckboxChange(categoryIndex, 'delete')}
                  />
                  <span className='text-[13px] leading-[18px] tracking-[-0.08px] py-1'>
                    {category.delete}
                  </span>
