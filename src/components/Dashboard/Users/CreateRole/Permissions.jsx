...
export default function Permissions({
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="rounded-2xl w-full p-4 pb-[58px] h-full flex flex-col gap-2 bg-LightGrey">
        <div className="flex justify-between px-2 bg-white h-full w-full items-center">
          <input
