                ...
                <div className="flex flex-col gap-2">
                    {SidebarData.map((item, index) => (
                        <div onClick={() => clickHandler(item.title)}
                            key={index}
                            className={`flex pl-2 cursor-pointer gap-2 items-center w-full rounded-lg ${memoizedActiveItem.active === item.title ? "border-BlueColor border text-BlueColor" : "border-white border"}`}
                        >
